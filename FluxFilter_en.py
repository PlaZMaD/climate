...
create_archive(arc_path=eproc_arc_path, dirs='output/reddyproc', top_dir='output/reddyproc',
...
create_archive(arc_path=arc_path, dirs=['output', 'output/reddyproc'], top_dir='output',
