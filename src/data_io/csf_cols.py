...
# TODO 1 QOA WRONG
TMP_ALL_LIST = ['FC', 'FC_mass', 'FC_QC', 'FC_samples', 'ET', 'ET_QC', 'ET_samples',
'LE', 'LE_QC', 'LE_samples', 'H', 'H_QC', 'H_samples', 'Bowen_ratio',
'TAU', 'TAU_QC', 'USTAR', 'TSTAR', 'TKE',
'e', 'e_sat', 'PA', 'PA_SIGMA', 'VPD',
'U', 'U_SIGMA', 'V', 'V_SIGMA', 'W', 'W_SIGMA', 'T_SONIC', 'T_SONIC_SIGMA', 'sonic_azimuth',
...
COLS_CSF_TO_SCRIPT_E_RENAMES = {
	'TIMESTAMP':'TIMESTAMP_STR'
}

COLS_SCRIPT_TO_CSF_RENAMES = {k.lower(): v for k, v in COLS_CSF_TO_SCRIPT_E_RENAMES.items()}
COLS_CSF_IMPORT_MAP = COLS_CSF_TO_SCRIPT_E_RENAMES | COLS_CSF_UNUSED_NORENAME_IMPORT_DICT

# TODO 1 If column must be converted on import, but on export same name and data?
COLS_CSF_TIME = [] # COLS_CSF_TIME = ['TIMESTAMP']
